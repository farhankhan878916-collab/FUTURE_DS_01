...
![Revenue Trends](screenshot_2_trends.png)

**Category, Region & Segment Breakdown**
![Breakdown](screenshot_3_breakdown.png)

Open `dashboard.html` in any browser to explore it live — no installation needed. It includes:
